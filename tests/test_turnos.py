...
class TestSiguientesTurnos(unittest.TestCase):
    ...
    def test_usar_unidad_toda_africa_en_africa(self):
        def build_mapa():
            return {'Argentina': [5, 'Africa', 'Fulano'],
                    'Uruguay': [10, 'Africa', 'Fulano'], 
                    'Chile': [1, 'America', None]}
        mapa = Mapa(build_mapa)
        siguientes_turnos = SiguientesTurnos('Fulano', mapa)
        ...
        self.assertEqual(
                siguientes_turnos.cant_unidades_africa(), unidades - 1)


    def test_usar_unidad_toda_europa_en_europa(self):
        def build_mapa():
            return {'Argentina': [5, 'Europa', 'Fulano'],
        ...
        self.assertEqual(
                siguientes_turnos.cant_unidades_europa(), unidades - 1)


    def test_usar_unidad_toda_oceania_en_oceania(self):
        def build_mapa():
            return {'Argentina': [5, 'Oceania', 'Fulano'],
        ...
        self.assertEqual(
                siguientes_turnos.cant_unidades_oceania(), unidades - 1)


    def test_usar_unidad_toda_asia_en_asia(self):
        def build_mapa():
            return {'Argentina': [5, 'Asia', 'Fulano'],
        ...
        self.assertEqual(
                siguientes_turnos.cant_unidades_asia(), unidades - 1)


    def test_usar_unidad_toda_sudamerica_en_sudamerica(self):
        def build_mapa():
            return {'Argentina': [5, 'Sudamerica', 'Fulano'],
        ...
        self.assertEqual(
                siguientes_turnos.cant_unidades_sudamerica(), unidades - 1)


    def test_usar_unidad_toda_norteamerica_en_norteamerica(self):
        def build_mapa():
            return {'Argentina': [5, 'Norteamerica', 'Fulano'],
        ...
        self.assertEqual(
                siguientes_turnos.cant_unidades_norteamerica(), unidades - 1)
